...
------------------------|---------------------------|----------------------
Настройка путей <br>поиска  | `setup_search_paths()`      | Формирование списка путей поиска<br> конфигурационных файлов. <br>[Подробнее о правилах поиска <br>конфигурационных файлов](../Build-Variants#configuration-files-search-paths).
