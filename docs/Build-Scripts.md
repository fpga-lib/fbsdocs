...
### Псевдобилдеры <a name="pseudo-builders"><a/>
...
Подготовка параметров сводится к чтению файлов параметров (см. [Конфигурационные файлы](Build-Variants.md#configuration-files)) и созданию внутренних объектов, которые являются по сути контейнерами этих параметров:
